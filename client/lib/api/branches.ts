...
export async function getBranches(options?: {
        ...
        return request<{ items: any[]; page: number; pageSize: number; total: number; totalPages: number }>(`/api/admin/branches?${params.toString()}`, {
...
export async function getBranchById(id: number | string, options?: {
        signal?: AbortSignal;
}) {
