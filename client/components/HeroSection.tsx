...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen bg-gradient-dark overflow-hidden">
      <Carousel setApi={setApi} opts={{ loop: true }} className="w-full h-screen">
        <CarouselContent>
      ...
      <div className="container mx-auto px-4 py-6 absolute bottom-10 left-0 right-0">
