          ...
          <Table>
            ...
            <TableBody>
              {isLoading
                ...
                : data.map((u) => (
                <TableRow key={u.id} className="group hover:bg-slate-50/80 transition-colors border-b last:border-0">
                  ...
                  <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      <div className="flex justify-between items-center">
                        ...
                        <Badge variant="outline" className="text-[9px] font-bold border-blue-200 text-blue-600 uppercase">
                      ...
                      <div className="flex justify-between items-center border-t pt-2 border-slate-50">
                        ...
                        <p className="text-[11px] font-mono text-slate-700">{formatDateTime(userDetails.user_created_at)}</p>
                      </div>
                      <div className="flex justify-between items-center border-t pt-2 border-slate-50">
                        <p className="text-[11px] text-slate-500 font-medium">Cập nhật lần cuối</p>
                        <p className="text-[11px] font-mono text-slate-700">{formatDateTime(userDetails.user_updated_at)}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-blue-600 rounded-xl p-5 text-white shadow-lg shadow-blue-200 relative overflow-hidden">
                  <div className="relative z-10 flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-[10px] uppercase font-bold tracking-tighter opacity-70 mt-1">Giao dịch hoàn tất</p>
                    </div>
                  </div>
