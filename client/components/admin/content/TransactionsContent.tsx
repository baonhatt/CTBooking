                                                                                ...
                                                                                >
                                                                                        ...
                                                                                        <TableCell className="text-[11px] text-slate-500 font-medium">
                                                                                                {(() => {
                                                                                                        ...
                                                                                                        if (t.paymentStatus === 'paid' && t.paidAt) {
                                                                                                                return (
                                                                                                                        <div
                                                                                                                                ...
                                                                                                                                title={`Thời gian thanh toán: ${new Date(t.paidAt).toLocaleString("vi-VN")}`}
                                                                                                                        >
                                                                                                                                ...
                                                                                                                                <Badge
                                                                                                                                        variant="outline"
                                                                                                                                        className="border-emerald-200 bg-emerald-50 text-emerald-700 px-2 py-0.5 text-[10px] font-bold whitespace-nowrap w-fit"
                                                                                                                                >
                                                                                                                                        Đã Thanh Toán
                                                                                                                                </Badge>
                                                                                                                        </div>
                                                                                                        ...
                                                                                                        // Failed: show updatedAt
                                                                                                        if (t.paymentStatus === 'failed' && t.updatedAt) {
                                                                                                                return (
                                                                                                                        <div
                                                                                                                                className="flex flex-col gap-1 cursor-help"
                                                                                                                                title={`Thời gian hủy: ${new Date(t.updatedAt).toLocaleString("vi-VN")}`}
                                                                                                                        >
                                                                                                                                <span className="text-slate-700 font-bold text[-10px]">
                                                                                                                                        {formatDistanceToNow(new Date(t.updatedAt), { addSuffix: true, locale: vi })}
                                                                                                                                </span>
                                                                                                                                <Badge
                                                                                                                                        variant="outline"
                                                                                                                                        className="border-red-200 bg-red-50 text-red-700 px-2 py-0.5 text-[10px] font-bold whitespace-nowrap w-fit"
                                                                                                                                >
                                                                                                                                        Đã Hủy
                                                                                                                                </Badge>
                                                                                                                        </div>
                                                                                                        ...
                                                                                                        // Pending: show createdAt
                                                                                                        if (t.paymentStatus === 'pending' && t.createdAt) {
                                                                                                                return (
                                                                                                                        <div
                                                                                                                                className="flex flex-col gap-1 cursor-help"
                                                                                                                                title={`Thời gian tạo: ${new Date(t.createdAt).toLocaleString("vi-VN")}`}
                                                                                                                        >
                                                                                                                                <span className="text-slate-700 font-bold text[-10px]">
                                                                                                                                ...
                                                                                                                                <Badge
                                                                                                                                        variant="outline"
                                                                                                                                        className="border-amber-200 bg-amber-50 text-amber-700 px-2 py-0.5 text-[10px] font-bold whitespace-nowrap w-fit"
                                                                                                                                >
                                                                                                                                        Chờ Thanh Toán
                                                                                                                                </Badge>
                                                                                                                        </div>
                                                                                ...
                                                                                >
                                                                                        <div className="flex items-center gap-3">
                                                                                                ...
                                                                                                {txDetails.payment_info?.expired &&
                                                                                                        ...
                                                                                                        txDetails.payment_info?.payment_status === "paid" && !txDetails.booking_details?.is_used ? (
                                                                                                                <Badge className="bg-emerald-100 text-emerald-700 border-emerald-200 py-1 font-bold">
                                                                                                                        SẴN SÀNG SỬ DỤNG
                                                                                                                </Badge>
