    ...
    <div className="max-w-7xl mx-auto space-y-8 pb-20 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border shadow-sm">
        <div className="flex flex-col gap-1">
          <h1 className="text-2xl font-black text-slate-900 tracking-tight uppercase">HỆ THỐNG KIỂM SOÁT</h1>
      ...
      <div className="max-w-3xl space-y-4">
        ...
        <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 flex gap-3 shadow-sm">
          ...
          <div className="text-xs text-amber-800 leading-relaxed">
            <p className="font-bold mb-1 uppercase">Hướng dẫn đối soát nhanh:</p>
            <p>
          ...
          <div className="lg:col-span-8 space-y-6">
              ...
              <CardContent className="p-0">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-6 border-t border-slate-100">
                    ...
                    <div className="space-y-1">
                      <p className="text-[10px] font-bold text-green-500 uppercase">Thanh toán</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
              ...
              <Card className="md:col-span-3 p-4 flex items-center gap-3 border-none bg-white shadow-xl shadow-slate-100 rounded-2xl">
                ...
                <div className="w-full">
                  <p className="text-[10px] font-bold text-slate-400 uppercase">SĐT</p>
              ...
              <Card className="md:col-span-5 p-4 flex items-center gap-3 border-none bg-white shadow-xl shadow-slate-100 rounded-2xl">
                ...
                <div className="w-full">
                  <p className="text-[10px] font-bold text-slate-400 uppercase">Email đối soát</p>
                ...
                <div className="pt-4">
                  ...
                  {ticketInfo.payment_status === 'failed' && !allowConfirmCancelled ? (
                    <div className="py-5 px-6 rounded-2xl bg-red-50 text-red-600 font-bold border border-red-100 flex flex-col gap-2 shadow-inner">
                      <div className="flex items-center justify-center gap-2">
                        <AlertCircle size={24} />
                        <span className="text-xl uppercase font-black">Giao dịch đã hủy</span>
                      </div>
                  ...
                  ticketInfo.expired ? (
                    <div className="py-5 px-6 rounded-2xl bg-slate-200 text-slate-600 font-bold border border-slate-300 flex flex-col gap-2 shadow-inner">
                      <div className="flex items-center justify-center gap-2">
                        <AlertCircle size={24} />
                        <span className="text-xl uppercase font-black">Không thể sử dụng</span>
                      </div>
                  ...
                  ticketInfo.payment_status !== 'paid' ? (
                    <Button
                      ...
                      disabled={useLoading}
                      className={`w-full h-16 text-lg font-black uppercase shadow-lg ${
                    ...
                    <div className="space-y-4">
                      <div className="py-5 px-6 rounded-2xl bg-slate-50 text-slate-400 font-bold border border-slate-100 flex flex-col gap-2">
                        <div className="flex items-center justify-center gap-2 text-red-500">
                          <AlertCircle size={24} />
                          <span className="text-xl uppercase font-black">Đã sử dụng</span>
                        </div>
            ...
            >
              ...
              <CardContent className="p-6 space-y-5 relative z-10">
                ...
                <div className="pt-5 border-t border-slate-800 flex justify-between items-end">
                  <span className="text-xs font-bold opacity-60 uppercase">Tổng thanh toán:</span>
                  <span
                        ...
                        >
                            <CardContent className="p-0">
                                <div className={`p-6 border-b flex justify-between items-center ${
                                    ...
                                    <Badge className={`px-4 py-1.5 flex gap-2 items-center border-none font-black text-sm shadow-sm text-white ${
                                        ticketInfo.booking_type === 'vr'
                                            ? 'bg-purple-600'
                                            : 'bg-red-500'
                                    }`}>
                                        ...
                                        } LƯỢT CHƠI` : `${ticketInfo.ticket_count} VÉ`}
                                    </Badge>
                                </div>
                                                    ...
                                                    <Table>
                                                        <TableHeader className="bg-purple-50/60">
                                                            <TableRow className="hover:bg-transparent border-none">
                                                                <TableHead className="text-[10px] font-bold uppercase text-purple-700 py-3">Tên gói VR</TableHead>
                                                                <TableHead className="text-center text-[10px] font-bold uppercase text-purple-700 py-3">SL</TableHead>
                                                                <TableHead className="text-right text-[10px] font-bold uppercase text-purple-700 py-3">Đơn giá</TableHead>
                                                                <TableHead className="text-right text-[10px] font-bold uppercase text-purple-700 py-3">Thành tiền</TableHead>
                                                            </TableRow>
                                                        </TableHeader>
                                                        <TableBody>
                                                            {ticketInfo.vr_items.map((it, idx) => {
                                                                ...
                                                                return (
                                                                    <TableRow key={it.id || `vr-${idx}`} className="border-t border-purple-50 hover:bg-purple-50/30">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-4 border-t border-dashed border-orange-200">
                                            ...
                                            <div className="bg-green-50/60 border border-green-100 rounded-xl p-3">
                                                ...
                                                <p className="text-sm font-black text-green-700">
                                                    {formatMoney(ticketInfo.total_price)}
                                                </p>
                                            </div>
                                        </div>
                                    )}
