            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
              ...
              <Card className="md:col-span-5 p-4 flex items-center gap-3 border-none bg-white shadow-xl shadow-slate-100 rounded-2xl">
                ...
                <div className="w-full">
                  ...
                  <p className="font-bold text-slate-700 break-all leading-tight">
                    {ticketInfo.email}
                  </p>
                </div>
              </Card>
            ...
            >
              <CardContent className="p-6 text-center space-y-6">
                <div className="space-y-2">
                  <h2
                    className={`text-3xl font-black uppercase tracking-tighter ${ticketInfo.expired
                  ...
                  {ticketInfo.payment_status === "failed" && !allowConfirmCancelled ? (
                    <div className="py-5 px-6 rounded-2xl bg-red-50 text-red-600 font-bold border border-red-100 flex flex-col gap-2 shadow-inner">
                      ...
                      <p className="text-xs opacity-80">
                        Giao dịch này đã bị hủy và không còn hiệu lực
                      </p>
                    ...
                    ticketInfo.expired ? (
                      ...
                      ticketInfo.payment_status !== "paid" ? (
                        <Button
                          ...
                          disabled={useLoading}
                          className={`w-full h-16 text-lg font-black uppercase shadow-lg ${ticketInfo.payment_status === 'failed'
                            ? "bg-red-600 hover:bg-red-700 shadow-red-200"
                            : "bg-amber-500 hover:bg-amber-600 shadow-amber-200"
                            }`}
                        >
                          {ticketInfo.payment_status === 'failed' ? "Khôi phục & Xác nhận thanh toán" : "Xác nhận thanh toán"}
                        </Button>
        ...
        <AlertDialogContent className="rounded-2xl border-none shadow-2xl p-8">
          ...
          <AlertDialogFooter className="gap-3 mt-6">
            ...
            <AlertDialogAction
              ...
              disabled={useLoading}
              className={`h-12 px-8 rounded-xl font-black uppercase min-w-[160px] ${confirmType === "checkin"
