...
export const PostManagement = () => {
  ...
  const [sections, setSections] = useState<{ publish: boolean; images: boolean; seo: boolean }>({
    publish: true,
    images: true,
    seo: false
  });
                      ...
                      <CardContent className="p-4 space-y-4">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            className="h-10 mt-2"
                            value={
                              editData.published_at ? new Date(editData.published_at).toISOString().slice(0, 16) : ''
                            }
                          ...
                          <div className="mt-2 flex items-center gap-2">
                            ...
                            <Button
                              ...
                              onClick={() =>
                                setEditData({
                                  ...editData,
                                  canonical_url: editData.slug
                                    ? `https://cinesphere.com.vn/bai-viet/${editData.slug}`
                                    : ''
                                })
                              }
            ...
            <article className="max-w-3xl mx-auto p-6 md:p-8 space-y-6">
              ...
              <header className="space-y-3">
                ...
                <div className="flex flex-wrap items-center gap-2 text-xs text-slate-500">
                  ...
                  {editData.created_by_staff_name && <span>Tạo bởi: {editData.created_by_staff_name}</span>}
                  {editData.updated_by_staff_name && <span>Cập nhật bởi: {editData.updated_by_staff_name}</span>}
                </div>
