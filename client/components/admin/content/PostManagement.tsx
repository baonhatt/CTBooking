...
export const PostManagement = () => {
  ...
  const columns: ColumnsType<PostData> = useMemo(
    () => [
      {
        title: 'ID',
        dataIndex: 'id',
        ...
        width: 80,
        align: 'center',
        render: (v) => <span className="text-center font-mono text-xs text-slate-500">#{v}</span>
      },
      {
        title: 'Tiêu đề',
        dataIndex: 'title',
      ...
      },
      {
        ...
        width: 130,
        responsive: ['sm'],
        render: (v) => <span className="text-xs text-slate-500">{v ? new Date(v).toLocaleDateString('vi-VN') : '---'}</span>
      },
      {
        title: 'Lượt xem',
      ...
      },
      {
        ...
        width: 100,
        render: (_: any, post: PostData) => {
          const canEdit = !isViewer && (isSuperAdmin || hasPermission('posts.edit'));
          return (
    ...
    [isViewer, isSuperAdmin, hasPermission]
  );
      ...
      <div className="flex flex-col min-h-0 md:flex-row justify-between items-start md:items-center gap-4 bg-white p-4 rounded-2xl border shadow-sm">
        ...
        <div className="flex flex-1 w-full md:max-w-xl gap-2 ml-auto">
          ...
          <div className="flex gap-2 items-center">
            ...
            {!isViewer && (isSuperAdmin || hasPermission('posts.create')) && (
              <Button
