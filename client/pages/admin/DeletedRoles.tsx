              ...
              <TableBody>
                {roles.map((r) => (
                  <TableRow key={r.id}>
                    ...
                    <TableCell>{r.deleted_at ? new Date(r.deleted_at).toLocaleString('vi-VN') : '-'}</TableCell>
                    <TableCell className="text-right">
                      {hasPermission('roles', 'restore') && (
                        <Button onClick={() => handleRestore(r.id)} variant="outline" size="sm">
      ...
      <AlertDialog open={restoreDialogOpen} onOpenChange={setRestoreDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>Bạn có chắc chắn muốn khôi phục vai trò này?</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
