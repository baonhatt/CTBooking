...
import { Settings as SettingsIcon, LayoutDashboard, Users, Clapperboard, Package, Ticket, CreditCard, ScanLine, Eye, Mail } from "lucide-react";
                ...
                <div className="relative z-10 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <p className="text-slate-400 text-sm font-medium">Bật/Tắt các đề mục trên thanh điều hướng để tối ưu hóa diện tích</p>
                      {isProd && (
                        <Badge variant="outline" className={`ml-2 text-[10px] ${isSyncing ? 'animate-pulse bg-blue-500/10 text-blue-400 border-blue-400/20' : 'bg-green-500/10 text-green-400 border-green-400/20'}`}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {ALL_TABS.map((tab) => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <div className={`w-11 h-11 rounded-xl flex items-center justify-center transition-all duration-500 ${isHidden ? 'bg-slate-200 text-slate-400' : 'bg-blue-50 text-blue-600 group-hover:bg-blue-600 group-hover:text-white'
                            }`}>
                            <Icon size={20} />
                          </div>
