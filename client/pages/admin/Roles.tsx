            ...
            <div className="flex gap-6">
                  ...
                  {roles.map((role: Role) => (
                    <div
                      ...
                      className={`p-3 rounded-lg cursor-pointer border transition-colors ${
                        selectedRoleId === role.id ? 'bg-blue-50 border-blue-500' : 'hover:bg-gray-50 border-gray-200'
                      }`}
                    ...
                    >
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          {role.description && <div className="text-sm text-gray-600">{role.description}</div>}
                        </div>
                        {role.isSystem && (
              ...
              <div className="flex-1">
                {roleLoading ? (
                  ...
                  <div className="text-center text-gray-500 py-12">Chọn một vai trò để xem và chỉnh sửa quyền</div>
                )}
              </div>
            </div>
          </CardContent>
