        ...
        <CardContent>
          <div className="space-y-3">
            <form onSubmit={handleSetup}>
              <div>
                <Label>Email</Label>
                <Input className="text-black" value={email} onChange={(e) => setEmail(e.target.value)} required />
              </div>
              <div>
                <Label>Họ tên</Label>
                <Input className="text-black" value={fullname} onChange={(e) => setFullname(e.target.value)} required />
              </div>
              <div>
