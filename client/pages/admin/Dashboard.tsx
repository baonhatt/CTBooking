...
export default function DashboardPage() {
        ...
        const [dateRevenue, setDateRevenue] = useState({ total: 0, count: 0, revenueByMethod: { cash: 0, momo: 0, vnpay: 0, vietqr: 0 } });
        ...
        const handleApplyDateFilter = async () => {
                try {
                        ...
                        if (dateFilterType === "year") {
                                ...
                                if ('total' in data) {
                                        setDateRevenue({ total: data.total, count: data.count, revenueByMethod: (data as any).revenueByMethod || { cash: 0, momo: 0, vnpay: 0, vietqr: 0 } });
                                }
                        }
                } catch (err) {
