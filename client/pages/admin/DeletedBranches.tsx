              ...
              <TableBody>
                {branches.map((b) => (
                  <TableRow key={b.id}>
                    ...
                    <TableCell>{b.deleted_at ? new Date(b.deleted_at).toLocaleString('vi-VN') : '-'}</TableCell>
                    <TableCell className="text-right">
                      {hasPermission('branches', 'restore') && (
                        <Button onClick={() => handleRestore(b.id)} variant="outline" size="sm">
      ...
      <AlertDialog open={restoreDialogOpen} onOpenChange={setRestoreDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>Bạn có chắc chắn muốn khôi phục chi nhánh này?</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
