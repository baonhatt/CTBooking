                                                        ...
                                                        <tbody>
                                                                {branches.map((branch) => (
                                                                        <tr key={branch.id} className="hover:bg-gray-50">
                                                                                ...
                                                                                <td className="px-4 py-3 border text-center">
                                                                                        <span className={`px-2 py-1 rounded text-xs ${branch.is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className="bg-white rounded-lg p-6 w-full max-w-md">
                                <h2 className="text-xl font-bold mb-4">
                                        {data.id === 0 ? 'Thêm chi nhánh mới' : 'Sửa chi nhánh'}
                                </h2>
                                <form onSubmit={handleSubmit}>
                                        <div className="space-y-4">
                                                ...
                                                <div className="flex items-center gap-2">
                                                        ...
                                                        />
                                                        <label htmlFor="is_default" className="text-sm">Chi nhánh mặc định</label>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                        <input
                                                                type="checkbox"
