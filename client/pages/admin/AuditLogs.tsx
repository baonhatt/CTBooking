                                        ...
                                        <div className="flex flex-1 gap-3 max-w-xl">
                                                <div className="relative flex-1">
                                                        ...
                                                        <Input
                                                                ...
                                                                className="pl-10 bg-slate-50 border-transparent focus:bg-white focus:ring-2 focus:ring-blue-500 rounded-xl text-sm"
                                                        />
                                                </div>
                                                <Button
                                                        variant="outline"
                                                ...
                                                <Table>
                                                        ...
                                                        <TableBody>
                                                                {logs.map((log: AuditLog) => (
                                                                        <TableRow key={log.id} className="group hover:bg-gray-50 transition-colors border-b border-gray-200 h-[52px]">
                                                                                <TableCell className="text-sm text-slate-600">{formatDate(log.createdAt)}</TableCell>
                                                                                <TableCell>
                                                                                        <div className="flex flex-col">
                                                                                                <span className="font-medium text-slate-900">{log.staffFullname || `Staff #${log.staffId}`}</span>
                                                                                                <span className="text-xs text-slate-500">{log.staffEmail || '-'}</span>
                                                                                        </div>
                                                                                </TableCell>
                                                                                <TableCell>
                                                                                        <Badge
                                                                                                className={`text-xs font-medium px-2 py-0.5 rounded-full border ${ACTION_COLORS[log.action] || 'bg-gray-100 text-gray-800 border-gray-200'
                                                                                                        }`}
                                                                                        >
                                                                                                {ACTION_LABELS[log.action] || log.action}
                                                                                        </Badge>
                                                                                </TableCell>
                                                                                <TableCell className="text-sm text-slate-600">{formatEntityLabel(log.entityType, log.entityId)}</TableCell>
