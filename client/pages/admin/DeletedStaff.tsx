                ...
                <TableRow>
                  ...
                  <TableHead
                    ...
                    onClick={() => {
                      ...
                      setSortDir(sortField === 'fullname' && sortDir === 'asc' ? 'desc' : 'asc');
                    }}
                  >
              ...
              <TableBody>
                {staff.map((s) => (
                  <TableRow key={s.id}>
                    ...
                    <TableCell>{s.deleted_at ? new Date(s.deleted_at).toLocaleString('vi-VN') : '-'}</TableCell>
                    <TableCell className="text-right">
                      {hasPermission('staff', 'restore') && (
                        <Button onClick={() => handleRestore(s.id)} variant="outline" size="sm">
      ...
      <AlertDialog open={restoreDialogOpen} onOpenChange={setRestoreDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>Bạn có chắc chắn muốn khôi phục nhân viên này?</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
