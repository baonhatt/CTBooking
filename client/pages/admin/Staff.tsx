                        ...
                        <div className="p-6">
                                <Card>
                                        ...
                                        <CardContent>
                                                ...
                                                <div className="flex gap-4 mb-6">
                                                        ...
                                                        <Button variant="outline" onClick={() => { setSearch(''); setFilterRole(''); setFilterBranch(''); }}>
                                                                Xóa filter
                                                        </Button>
                                                </div>
                                                                        ...
                                                                        {staffList.map((staff: Staff) => (
                                                                                <tr key={staff.id} className="border-b hover:bg-gray-50">
                                                                                        ...
                                                                                        <td className="p-3">
                                                                                                ...
                                                                                                {staff.forcePasswordChange && <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded text-xs ml-1">Đổi mật khẩu</span>}
                                                                                        </td>
                                                                                        <td className="p-3">
                                                                                                <div className="flex gap-2">
                                                                                                        ...
                                                                                                        {hasPermission('staff', 'reset_password') && (
                                                                                                                <Button variant="ghost" size="sm" onClick={() => { setSelectedStaff(staff); setIsResetPasswordDialogOpen(true); }}>
                                                                                                                        Đặt lại mật khẩu
                                                                                                                </Button>
                                                                                                        )}
                                                                                                        {!staff.isSuperAdmin && hasPermission('staff', 'delete') && (
                                                                                                                <Button variant="ghost" size="sm" className="text-red-600" onClick={() => { setSelectedStaff(staff); setIsDeleteDialogOpen(true); }}>
                                                                                                                        Xóa
                                                                                                                </Button>
                                                                                                        )}
                                                                                                </div>
                                ...
                                <Dialog open={isResetPasswordDialogOpen} onOpenChange={setIsResetPasswordDialogOpen}>
                                        <DialogContent>
                                                ...
                                                <p className="py-4">
                                                        Bạn có chắc chắn muốn đặt lại mật khẩu cho nhân viên "{selectedStaff?.fullname}"? Mật khẩu mới sẽ được hiển thị sau khi xác nhận.
                                                </p>
                                                <DialogFooter>
