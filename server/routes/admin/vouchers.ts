import { eq, desc, or, count, and, isNull, isNotNull, like, sql, sum } from 'drizzle-orm';
...
export async function listVouchersImpl(
        ...
        args: { page: number; pageSize: number; q: string; scope?: string; is_active?: string; sale_staff_id?: string | number }
) {
        const { page, pageSize, q, scope, is_active, sale_staff_id } = args;
