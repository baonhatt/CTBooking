...
export async function registerImpl(anyDb: any, tables: { accounts: any; users: any; email_logs?: any }, payload: Partial<Register> & { gender?: string; dob?: string; phone?: string; name?: string }, sendMailFn?: (to: string, subject: string, html: string) => Promise<any>, getWelcomeEmailHtml?: (data: { customerName: string; email: string }) => string, RUNTIME_ENV?: string, context?: { waitUntil: (promise: Promise<any>) => void }) {
        try {
