...
export async function forgetPassImpl(anyDb: any, tables: { accounts: any; tokens: any; email_logs?: any }, email: string, sendMailFn?: (to: string, subject: string, html: string) => Promise<any>, getResetPasswordEmailHtml?: (link: string) => string, RUNTIME_ENV?: string, context?: { waitUntil: (promise: Promise<any>) => void }) {
