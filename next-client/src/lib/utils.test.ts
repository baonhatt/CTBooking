...
import {
  ...
  formatDOB
} from './utils'; // next-client/src/lib/utils uses formatDate instead of formatDateVN

// Store original TZ to restore later if necessary
const originalTZ = process.env.TZ;

describe('Timezone Utils - Next Client', () => {
  beforeAll(() => {
  ...
  it('Case 1: Booking tạo gần nửa đêm VN (23:45 21/9 VN)', () => {
    ...
    expect(displayTime).toContain('23:45'); // Nên có 23:45
  });
