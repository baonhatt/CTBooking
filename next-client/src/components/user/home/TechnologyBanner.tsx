        ...
        >
          <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
            ...
            <div className="w-full md:basis-7/12 lg:basis-7/12 space-y-8">
              ...
              <p className="text-lg text-gray-300 leading-relaxed"><span className="text-white font-semibold">Trải Nghiệm Đắm Chìm Không Giới Hạn:</span> Với hệ thống màn hình đa diện bao quanh, chúng tôi tái tạo những khung cảnh vĩ đại.</p>
              <p className="text-lg text-gray-300 leading-relaxed"><span className="text-white font-semibold">Siêu Định Dạng 8K+8K:</span> Hãy chuẩn bị để ngỡ ngàng trước những thước phim CG siêu phân giải 8K.</p>
              <p className="text-lg text-gray-300 leading-relaxed"><span className="text-white font-semibold">Xuyên Không Trong Chớp Mắt:</span> Chỉ một cái chạm, bối cảnh sẽ thay đổi tức thì.</p>
              <p className="text-lg text-gray-300 leading-relaxed"><span className="text-white font-semibold">Thánh Địa "Check-in" Nghệ Thuật:</span> Không chỉ để xem, Huyễn Cảnh Không Gian còn là studio hoàn hảo để bạn sở hữu những bức ảnh nghệ thuật đầy ảo diệu.</p>
            </div>
          </div>
        </motion.div>
