...
export function ErrorModal({ open, title, message, onOpenChange }: ErrorModalProps) {
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="z-[10000] bg-gradient-to-br from-[#0b1226] via-[#0e1b3d] to-[#050915] border border-red-500/30 text-white shadow-[0_0_50px_rgba(239,68,68,0.3)]">
        <AlertDialogHeader>
