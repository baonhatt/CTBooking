              ...
              {(vrItems?.length > 0 || (order?.vr_items && order.vr_items.length > 0)) && (
                <div className="p-3 pb-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h2 className="text-[10px] font-bold text-purple-400 uppercase tracking-widest">
                      Trải nghiệm VR kèm theo
                    </h2>
                  </div>
                  <div className="space-y-2">
              ...
              <div className="p-3 pt-1 grid grid-cols-2 gap-x-6 gap-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm md:text-base font-bold text-slate-200">
                    {!isVR ? order?.ticketPackageName || 'Vé đơn' : '🎮 Trải nghiệm VR'}
                  </p>
                </div>
                ...
                {isVR && vrItems?.length > 0 && (
                  <div className="space-y-1">
                    ...
                    <p className="text-sm md:text-base font-bold text-slate-200">{vrItems.length} gói</p>
                  </div>
                )}
                ...
                {status === 'success' && (
                  ...
                  >
                    ...
                    <span>
                      Hệ thống đã gửi{' '}
                      {!isVR
                        ? 'thông tin vé chi tiết và **Mã đặt vé**'
                        : 'thông tin trải nghiệm VR chi tiết và **Mã đặt chỗ**'}{' '}
                      tới <b>{order?.email}</b>. Quý khách vui lòng kiểm tra email (bao gồm cả thư rác).
                    </span>
                  </motion.div>
                )}
